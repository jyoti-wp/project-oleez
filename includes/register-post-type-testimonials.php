...
function create_testimonials_cpt() {
	...
	$labels = array(
		'name' => _x( 'Testimonials', 'Post Type General Name', 'oleez' ),
		'singular_name' => _x( 'Testimonials', 'Post Type Singular Name', 'oleez' ),
		'menu_name' => _x( 'Testimonials', 'Admin Menu text', 'oleez' ),
		...
		'all_items' => __( 'All Testimonials', 'oleez' ),
		...
		'view_items' => __( 'View Testimonials', 'oleez' ),
		...
		'items_list' => __( 'Testimonials list', 'oleez' ),
		'items_list_navigation' => __( 'Testimonials list navigation', 'oleez' ),
		'filter_items_list' => __( 'Filter Testimonials list', 'oleez' ),
	);
	$args = array(
		'label' => __( 'Testimonials', 'oleez' ),
		'description' => __( 'Testimonials post type', 'oleez' ),
		'labels' => $labels,
		'menu_icon' => '',
